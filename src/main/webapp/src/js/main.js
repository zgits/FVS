...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        $("body").append('<div id="' + this.id.slice(1, this.id.length) + 'fontTip"  hidden="true">' +
            ...
            '<input type="radio" checked="checked"  name="danmu_position" value=1 />滚动&nbsp;&nbsp;<input type="radio" name="danmu_position" value=2 />顶端' +
            '&nbsp;&nbsp;<input type="radio" name="danmu_position" value=3 />底端&nbsp;&nbsp;</form>' +
